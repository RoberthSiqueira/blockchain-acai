...
function payOut(shipmentReceived) {
    ...
    console.log('Farmer: ' + contract.farmer.$identifier + ' new balance: ' + contract.farmer.accountBalance);
    console.log('Importer: ' + contract.importer.$identifier + ' new balance: ' + contract.importer.accountBalance);

    return getParticipantRegistry('org.acme.shipping.perishable.Farmer')
        .then(function (farmerRegistry) {
            // update the farmer's balance
            return farmerRegistry.update(contract.farmer);
        })
        .then(function () {
...
function geraLaudo(geraLaudo) {
    ...
    // create the farmer
    var farmer = factory.newResource(NS, 'Farmer', 'lucas@email.com');
    var farmerAddress = factory.newConcept(NS, 'Address');
    farmerAddress.country = 'BR';
    ...
    contract.farmer = factory.newRelationship(NS, 'Farmer', 'lucas@email.com');
