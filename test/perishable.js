    ...
    describe('#shipment', () => {
        ...
        it('should receive base price for a shipment within temperature range', () => {
            ...
            return businessNetworkConnection.submitTransaction(tempReading)
                ...
                .then((farmerRegistry) => {
                    // check the farmer's balance
                    return farmerRegistry.get(farmer_id);
                })
                .then((newFarmer) => {
                    // console.log(JSON.stringify(businessNetworkConnection.getBusinessNetwork().getSerializer().toJSON(newFarmer)));
